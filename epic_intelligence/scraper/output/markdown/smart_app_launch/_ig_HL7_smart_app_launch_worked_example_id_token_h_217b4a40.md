# Example Id Token - SMART App Launch v2.2.0

> Source: https://build.fhir.org/ig/HL7/smart-app-launch/worked_example_id_token.html
...
## Example Id Token
 ...
 - [Creating an ID Token (for servers)](#creating-an-id-token-for-servers)

 - [Validating and using an ID Token (for clients)](#validating-and-using-an-id-token-for-clients)
