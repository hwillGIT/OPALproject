# Best Practices - SMART App Launch v2.2.0

> Source: https://build.fhir.org/ig/HL7/smart-app-launch/best-practices.html
...
## Best Practices
 ...
 - [Best practices for server developers include](#best-practices-for-server-developers-include)

 - [Best practices for app developers include](#best-practices-for-app-developers-include)

 - [Considerations for Scope Consent](#considerations-for-scope-consent)

 - [App and Server developers should consider trade-offs associated with confidential vs public app architectures](#app-and-server-developers-should-consider-trade-offs-associated-with-confidential-vs-public-app-architectures)
