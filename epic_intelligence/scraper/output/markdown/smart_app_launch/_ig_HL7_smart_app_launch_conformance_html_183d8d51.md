# Conformance - SMART App Launch v2.2.0

> Source: https://build.fhir.org/ig/HL7/smart-app-launch/conformance.html
...
## Conformance
 ...
 - [FHIR Authorization Endpoint and Capabilities Discovery using a Well-Known Uniform Resource Identifiers (URIs)](#using-well-known)
...
##### Patient Access for Standalone Apps
 ...
 - At least one of `client-public` or `client-confidential-symmetric`; and MAY support `client-confidential-asymmetric`
...
##### Clinician Access for EHR Launch
 ...
 - `context-ehr-patient` support

 - `context-ehr-encounter` support
...
When a SMART on FHIR server supports the launch of an app from *within* an
...
When a SMART on FHIR server supports the launch of an app from *outside* an
...
As described in the underlying HTTP specifications, [header names are compared in a case-insensitive manner](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers).